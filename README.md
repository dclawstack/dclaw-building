...
[![Status](https://img.shields.io/badge/status-P4%20Planned-8B5CF6)](https://github.com/dclawstack/dclaw-building)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/building)

---

## Overview

DClaw Building is an AI-native real estate application. It follows the standard DClaw architecture:
...
DClaw Building uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-building.git
cd dclaw-building
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_building"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-building.git /opt/dclaw-building
cd /opt/dclaw-building
docker compose up -d
```

The app will be available at `https://building.dclawstack.io`.

### Kubernetes

```bash
cd helm/dclaw-building
helm dependency build
helm upgrade --install dclaw-building . \
...
- [Docs](https://docs.dclawstack.io/apps/building)
